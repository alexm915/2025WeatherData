...
int main(int argc, char *argv[]) {
  ...
  if (argc != 4) {
    ...
    printf("Example:/project/tools/bin/gzifiles /tmp/idc/surfdata "
           "\"*.xml,*.json\" 0.01\n");
    cout << R"(Example2:/project/tools/bin/gzifiles/log/idc "*.log.20*" 0.01)"
         << endl;
    printf("Example3:/project/tools/bin/procctl 300 "
           "project/tools/bin/gzipfiles /log/idc \"*.log20*\" 0.02\n\n");
    printf("Example4:/project/tools/bin/procctl 300 project/tools/bin/gzifiles "
