...
int main(int argc, char *argv[]){
    ...
    if(argc!=4){
        ...
        printf("Example3:/project/tools/bin/procctl 300 project/tools/bin/deletefiles /log/idc \"*.log20*\" 0.02\n\n");
        printf("Example4:/project/tools/bin/procctl 300 project/tools/bin/deletefiles /tmp/idc/surfdata \"*.xml,*json\" 0.01\n\n");

        printf("这是一个工具程序，用来清理历史数据文件或日志文件。\n");
        printf("本程序会把pathname目录及其子目录中timeout天之前，且符合matchstr条件的文件删除掉，timeout可以是小数。\n");
